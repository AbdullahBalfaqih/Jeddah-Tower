...
import { checkRateLimit, flagMaliciousClient } from '../lib/security/rate-limiter';
...
function assertAttackBlocked(testName: string, isBlocked: boolean, expectedReason: string) {
  if (isBlocked) {
    passedTests++;
